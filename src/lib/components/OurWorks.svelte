...
<div class=""
	...
	<IntersectionObserver id="portfolio"classNames="w-full bg-greyBG py-10 relative px-10 md:px-32">
		...
		<div class="max-md:grid max-md:place-items-center">
			<SectionTitle show={inView} title="Portfolio" />
		</div>
		<h4 class={`font-medium text-md md:text-2xl text-white my-5 md:my-20 ${inView?'opacity-100 translate-y-0':'translate-y-10 opacity-0'} delay-300 transition-[opacity,transform] duration-700 ease-in-out`}>Our extensive portfolio of successful projects showcases our ability to bring your dream home to life.</h4>
